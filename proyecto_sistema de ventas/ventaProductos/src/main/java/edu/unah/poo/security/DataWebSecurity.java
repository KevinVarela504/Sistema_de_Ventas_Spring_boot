...
.usersByUsernameQuery("SELECT usuario, contrasenia, 1 activo FROM administrador where usuario=?")
.authoritiesByUsernameQuery("select usuario, rol from administrador "
+ "where usuario = ?");
}
